...
为了让使得不同架构的程序能够在不进行重新编译的情况下，运行在目标平台上，我们需要使用[二进制翻译技术](https://zh.wikipedia.org/zh-my/%E4%BA%8C%E8%BF%9B%E5%88%B6%E7%BF%BB%E8%AF%91)。

Altman 提出二进制翻译可以分成三大类，分别是解释执行、静态二进制翻译以及动态二进制翻译[^1]。当然综合了他们的优点，我们也存在着混合二进制翻译系统。
